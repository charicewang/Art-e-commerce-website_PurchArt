 ...
 */function uploadFile($fileInfo, $allowExt = array('jpeg', 'jpg', 'gif', 'png', 'mov', 'mp4', 'PNG', 'webp', 'txt'), $maxSize = 2097152000, $flag = false, $uploadPath = 'uploads') {
    // 存放錯誤訊息
    $res = array();
    ...
    if (!empty($res))
        ...
        $res['mes'] = $fileInfo['name'] . ' 上架成功';
        $res['dest'] = $destination;
        echo "<a href='上架畫面.php'>返回上架畫面</a>";
        return $res;
    }
}
