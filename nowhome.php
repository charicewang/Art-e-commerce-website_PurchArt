...
<body>
    ...
    <header id="header">
        ...
        <nav>
            <ul>    
                <li><p><b><a href="#log_in" class="modal-open">Log in</a></b></p></li>
                ...
                <section id="log_in">
                    <form action="login.php" method="POST">
                            ...
                            <h1 style="text-align: center;">LOG IN</h1><br>
                                ...
                                <div class="form-item">
                                <input type="char" name="e-mail" placeholder="e-mail" id="ID" class="form-style" />
                                </div>
                                <div class="form-item">
                                <input type="password" name="password" placeholder="password" id="password" class="form-style" />
                                <!-- <div class="pw-view"><i class="fa fa-eye"></i></div> -->
                                <p><a href="login.html" ><small>creat new account</small></a></p>  
                                </div>
                                <div class="form-item">
        ...
        <section id="latest">
            ...
            <div>
                ...
                <div id="work_type" class="flex_container">
                    ...
                    <div class="item-content"  id="item-content3">
                        <div class="blog">
                            <div class= "pic">
                                <a href="nice boi.jpg" data-fancybox="group1" data-caption="グループ1キャプション">
                                    <img src="nice boi.jpg" alt="">
            ...
            <h3 id="show_more"  onclick = "getData()">more...</h3>
