               ...
               <!--插圖-->
                <div class="tab_container">
                    <div id="tab_1" class="tab_content">
                        <form action="upload圖片.php" method="post" enctype="multipart/form-data" onSubmit="return InputCheck(this)">
                            ...
                            <div style="margin-top: 20px;">
                                <div id="t_c" class="flex_container">
                                    ...
                                    <hr color="whitesmoke">
                                    <textarea calss="caption" name="intro" placeholder="caption"></textarea>
                                </div>
                   ...
                   <div id="tab_2" class="tab_content">
                        <form action="upload漫畫.php" method="post"  enctype="multipart/form-data" onSubmit="return InputCheck(this)">
                ...
                <!--動畫-->
                    <div id="tab_3" class="tab_content">
                        <form action="upload動畫.php" method="post" enctype="multipart/form-data" onSubmit="return InputCheck(this)">
                            <div class="big_tab">
                                <div class="tab_container">
                ...
                <div id="tab_4" class="tab_content novel">
                    <form action="upload小說.php" method="post" enctype="multipart/form-data" onSubmit="return InputCheck(this)">
                        ...
                        <div>
                            ...
                            <div id="tags2" class="flex_container">
                                <input id="tag2" type="text" placeholder="tag" name="tag">
                                <hr color="whitesmoke">
                                <div style="height: 5vh; width: 100%; text-align: left;">
                                    <input type="checkbox" name="filter" value="no">
                                    <label for="position">不接受其他使用者的編輯</label>
