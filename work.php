...
//圖片
$result = $link->query("select * from 作品, 圖片 where 作品.作品編號=圖片.作品編號 AND 作品.會員ID = $user_id;");
...
//影片
$result_vedio = $link->query("select * from 作品, 影片 where 作品.作品編號=影片.作品編號 AND 作品.會員ID = $user_id;");
...
//漫畫
$result_漫畫 = $link->query("select * from 作品, 漫畫 where 作品.作品編號=漫畫.作品編號 AND 作品.會員ID = $user_id;");
...
//文章
$result_文章 = $link->query("select * from 作品, 文章 where 作品.作品編號=文章.作品編號 AND 作品.會員ID = $user_id;");
                                    ...
                                    <section id="full_profile">
                                            <section class="basic">
                                                ...
                                                <div class="flex_container">
                                                    <h3 style="margin: 3%; width: fit-content;"><?php echo $user_name; ?></h3>
                                                </div>
                                                <div class="media">
                                                    <a href="https://www.instagram.com/citygirl0319/?hl=ja">
                                                       <img src="instagram (1).png"> 
                                            ...
                                            <div class="fu_caption">
                                                   <P>職業:<?php echo $user_occu; ?><br>
                                                   とりあえずなんか書いてみるとりあえずなんか書いてみる<br>
                                                   とりあえずなんか書いてみるとりあえずなんか書いてみるとりあえずなんか書いてみる<br>
                                                   とりあえずなんか書いてみるとりあえずなんか書いてみるとりあえずなんか書いてみるとりあえずなんか書いてみる<br>
                                                   とりあえずなんか書いてみる<br>
                                                   とりあえずなんか書いてみるとりあえずなんか書いてみるとりあえずなんか書いてみる<br></P>
                                            </div>
                                    </section>
                                </div>
                ...
                <form method="post" name="form1" id="form1" action="delete.php">    
                   <div class="tab_container">                     
                        <div id="tab_1" class="tab_content">
                            ...
                            <p style="margin-bottom: 100px; margin-left: 300px;"><input type="submit" name="button" id="button" value="submit" /></p>                              
                        </div>
