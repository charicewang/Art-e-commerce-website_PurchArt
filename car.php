...
<form method="post" name="form2" id="form2" action="pay.php">  
    <div id="app">
        <div class="container">
            <div class="item_header">
                <div class="item_detail">PRODUCT</div>
                <div class="price">PRICE</div>
                <!--<div class="count">數量</div> 
                <div class="amount">總計</div>-->
                <div class="operate">DELETE</div>
            </div>
            <div class="item_container" v-for="(item, index) in itemList" :key="item.id" >
                    <div class="item_header item_body">
                            ...
                            <div class="operate"> -->
                                ...
                                <input type="checkbox" name = "checkbox2[]" id = "checkbox_1" value="<?php echo $arr_購[--$i購][2]?>">
                            </div>
                    </div>
            </div>
            <input style="background-color:lightgray;position:relative;left:1100px;top:20px" type="submit" value="DELETE">
             <a href="paid.php"><h1 style="position:relative;left:1200px;color:black">PAY NOW -></h1></a>
