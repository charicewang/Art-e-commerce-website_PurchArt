...
//圖片
$result = $link->query("select * from 商品 where 會員ID = $user_id AND 商品種類 = '圖片';");
...
//影片
$result_vedio = $link->query("select * from 商品 where 會員ID = $user_id AND 商品種類 = '影片';");
...
//漫畫
$result_漫畫 = $link->query("select * from 商品 where 會員ID = $user_id AND 商品種類 = '漫畫';");
...
//文章
$result_文章 = $link->query("select * from 商品 where 會員ID = $user_id AND 商品種類 = '文章';");
...
<script>
            ...
            function getData_圖() {
                    ...
                    a2.href = "buy_func.php?value=" +arr_圖[i1][0];
            ...
            function getData_漫() {
                    ...
                    let a2 = document.createElement("a");
                    a2.href = "buy_func.php?value=" +arr_漫[icomic][0];
                    let img2 = document.createElement("img");
                    img2.src = "shopping-cart.png";
                    img2.style = "height: 20px; width: 20px; margin-left: 200px; margin-top: 0px;"
                    img2.id = `car${++lo}`;
            ...
            function getData_影() {
                    ...
                    let a2 = document.createElement("a");
                    a2.href = "buy_func.php?value=" +arr_影[ivideo][0];
                    let img2 = document.createElement("img");
                    img2.src = "shopping-cart.png";
                    img2.style = "height: 20px; width: 20px; margin-left: 200px; margin-top: 0px;"
                    img2.id = `car${++lo}`;
            ...
            function getData_文() {
                    ...
                    let a2 = document.createElement("a");
                    a2.href = "buy_func.php?value=" +arr_文[iartical][0];
                    let img2 = document.createElement("img");
                    img2.src = "shopping-cart.png";
                    img2.style = "height: 20px; width: 20px; margin-left: 200px; margin-top: 0px;"
                    img2.id = `car${++lo}`;
