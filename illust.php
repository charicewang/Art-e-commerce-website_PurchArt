...
$result作者 = $link->query("select * from 作品, 會員資料 where 作品.會員ID=會員資料.會員ID AND 作品.作品編號 = $ill1;");
...
<section>
    <div>
        ...
        </a><h2 style="position: relative; top: 60px; left: 350px;"><?php echo $arr_作者[0][2]; ?></h2>
    ...
    <div class="" style="position:relative;left:800px; top: -200px;">
        <div class="title"></div>
        <a href="http://localhost:3000/">want to chat with someone?</a>
    </div>
</body>
