 ...
 */function uploadFile($fileInfo, $allowExt = array('jpeg', 'jpg', 'gif', 'png', 'mov', 'mp4', 'PNG', 'webp', 'txt'), $maxSize = 20971520000000, $flag = false, $uploadPath = 'uploads') {
    // 存放錯誤訊息
    $res = array();
    ...
    if (!empty($res))
        ...
        echo "<a href='nowhome.php'>登出以成功修改資料</a>";
        return $res;
    }
}
